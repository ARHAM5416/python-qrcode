...
lbl=Label(window, text="QR Code Generator", fg='black', font=("Helvetica", 24))
lbl.place(x=55, y=45)
...
lbl=Label(window, text="Input your message to be made into a QR Code", fg='black', font=("Helvetica", 12))
